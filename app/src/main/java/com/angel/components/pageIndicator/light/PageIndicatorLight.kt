package com.angel.components.pageIndicator.light
...
fun PageIndicatorLight(
    ...
    PageIndicator(
        ...
        spacing = spacing,
        activeColor = PageIndicatorColors.pageIndicatorLightSelected,
        inactiveColor = PageIndicatorColors.pageIndicatorLightUnselected
    )
}