package com.angel.components.ui.theme.styles.bottomNavigationItem
...
@Stable
class BottomNavigationItemColors internal constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other == null || other !is BottomNavigationItemColors) return false
