package com.angel.components.iconButton.secondary.large
...
@Composable
fun IconButtonSecondaryLarge(
    modifier: Modifier = Modifier,
    onClick: () -> Unit,
    enabled: Boolean = true,
    icon: IconButtonIconType,
    style: IconButtonStyle = DefaultIconButtonStyles.SecondaryIconButton.largeStyle,
