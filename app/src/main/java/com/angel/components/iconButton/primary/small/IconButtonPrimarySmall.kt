package com.angel.components.iconButton.primary.small
...
@Composable
fun IconButtonPrimarySmall(
    modifier: Modifier = Modifier,
    onClick: () -> Unit,
    enabled: Boolean = true,
    icon: IconButtonIconType,
    style: IconButtonStyle = DefaultIconButtonStyles.PrimaryIconButton.smallStyle,
