package com.angel.components.iconButton.tertiary.large
...
@Composable
fun IconButtonTertiaryLarge(
    modifier: Modifier = Modifier,
    onClick: () -> Unit,
    enabled: Boolean = true,
    icon: IconButtonIconType,
    style: IconButtonStyle = DefaultIconButtonStyles.TertiaryIconButton.largeStyle,
