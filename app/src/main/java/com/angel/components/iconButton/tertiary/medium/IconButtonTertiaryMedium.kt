package com.angel.components.iconButton.tertiary.medium
...
@Composable
fun IconButtonTertiaryMedium(
    modifier: Modifier = Modifier,
    onClick: () -> Unit,
    enabled: Boolean = true,
    icon: IconButtonIconType,
    style: IconButtonStyle = DefaultIconButtonStyles.TertiaryIconButton.mediumStyle,
