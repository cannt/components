package com.angel.components.iconButton.tertiary.small
...
@Composable
fun IconButtonTertiarySmall(
    modifier: Modifier = Modifier,
    onClick: () -> Unit,
    enabled: Boolean = true,
    icon: IconButtonIconType,
    style: IconButtonStyle = DefaultIconButtonStyles.TertiaryIconButton.smallStyle,
