package com.angel.components.iconButton.primary.medium
...
@Composable
fun IconButtonPrimaryMedium(
    modifier: Modifier = Modifier,
    onClick: () -> Unit,
    enabled: Boolean = true,
    icon: IconButtonIconType,
    style: IconButtonStyle = DefaultIconButtonStyles.PrimaryIconButton.mediumStyle,
