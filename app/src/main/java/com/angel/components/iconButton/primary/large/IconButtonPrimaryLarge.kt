package com.angel.components.iconButton.primary.large
...
@Composable
fun IconButtonPrimaryLarge(
    modifier: Modifier = Modifier,
    onClick: () -> Unit,
    enabled: Boolean = true,
    icon: IconButtonIconType,
    style: IconButtonStyle = DefaultIconButtonStyles.PrimaryIconButton.largeStyle,
