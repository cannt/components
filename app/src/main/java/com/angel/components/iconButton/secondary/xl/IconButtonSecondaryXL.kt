package com.angel.components.iconButton.secondary.xl
...
@Composable
fun IconButtonSecondaryXL(
    modifier: Modifier = Modifier,
    onClick: () -> Unit,
    enabled: Boolean = true,
    icon: IconButtonIconType,
    style: IconButtonStyle = DefaultIconButtonStyles.SecondaryIconButton.xlStyle,
